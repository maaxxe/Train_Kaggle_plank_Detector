...
- last.pt
- best.pt
- best_angles.pt (si présent)
- best_corners.pt (si présent)
- le checkpoint périodique epoch_XXX.pt
- les petits fichiers de suivi/configuration
"""
...
def prepare_snapshot(
    ...
    # Resume + meilleurs checkpoints spécialisés.
...
def fetch_dataset_metadata(
    ...
    # CRITICAL: kaggle datasets version requires id or id_no.
    metadata["id"] = dataset
